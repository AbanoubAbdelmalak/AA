...
### "<ddd.hh\> product_name:price; product_name:price; product_name:price"<br/>

# Status
## The order processor acknowledges the receipt of the order form the customer
###  "order_(received/declined)"<br/>
...
###  "order_id;order_id;order_id;order_id"<br/>
...
### "product_id:quantity:due_time;product_id:quantity:due_time;product_id:quantity:due_time"<br/>

# getTimeToDelivery
## The product manager requests the time to tranport an order
###  "time_to_transport:order_id"<br/>
...
### "ready_to_knead;max_quantity"<br/>
...
### "item:quantity;item:quantity;item:quantity"<br/>
